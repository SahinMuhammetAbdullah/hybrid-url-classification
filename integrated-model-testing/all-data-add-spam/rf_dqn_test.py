...
# Modelleri yükle
rf_model = joblib.load("binary-pkl/rf_binary_model.pkl")
dqn_model = DQN.load("multiclass-add-spam-pkl/multiclass_dqn_add_spam_model")
...
for pred, true_label in zip(final_predictions, y_test_corrected):
    if true_label not in ["malicious"]:  # 'malicious' ve 'spam' etiketlerini dışarıda bırak
